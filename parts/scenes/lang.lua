...
scene.widgetList={
	...
	WIDGET.newButton{name="pt",		x=200,	y=250,w=200,h=120,font=45,code=setLang(6)},
	WIDGET.newButton{name="symbol",	x=420,	y=250,w=200,h=120,font=45,code=setLang(7)},
	WIDGET.newButton{name="yygq",	x=640,	y=250,w=200,h=120,font=45,code=setLang(8)},
